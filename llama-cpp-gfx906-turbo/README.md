...
`llama-bench -ngl 99 --no-warmup -r 3 -p 512,1024 -n 128,256`

### Qwen3.5 27B Q4_0 — f16 KV

```
| model                          |       size |     params | backend    | ngl |            test |                  t/s |
| ------------------------------ | ---------: | ---------: | ---------- | --: | --------------: | -------------------: |
| qwen35 27B Q4_0                |  14.63 GiB |    26.90 B | ROCm       |  99 |           pp512 |       266.96 ± 14.31 |
| qwen35 27B Q4_0                |  14.63 GiB |    26.90 B | ROCm       |  99 |          pp1024 |        351.06 ± 0.40 |
| qwen35 27B Q4_0                |  14.63 GiB |    26.90 B | ROCm       |  99 |           tg128 |         24.24 ± 0.29 |
| qwen35 27B Q4_0                |  14.63 GiB |    26.90 B | ROCm       |  99 |           tg256 |         24.47 ± 0.01 |
```

### Qwen3.5 27B Q4_0 — turbo3 KV

```
| model                          |       size |     params | backend    | ngl | type_k | type_v |            test |                  t/s |
| ------------------------------ | ---------: | ---------: | ---------- | --: | -----: | -----: | --------------: | -------------------: |
| qwen35 27B Q4_0                |  14.63 GiB |    26.90 B | ROCm       |  99 | turbo3 | turbo3 |           pp512 |       232.63 ± 12.66 |
| qwen35 27B Q4_0                |  14.63 GiB |    26.90 B | ROCm       |  99 | turbo3 | turbo3 |          pp1024 |        285.27 ± 0.10 |
| qwen35 27B Q4_0                |  14.63 GiB |    26.90 B | ROCm       |  99 | turbo3 | turbo3 |           tg128 |         20.57 ± 0.11 |
| qwen35 27B Q4_0                |  14.63 GiB |    26.90 B | ROCm       |  99 | turbo3 | turbo3 |           tg256 |         20.52 ± 0.01 |
```

### Qwen3.5 35B-A3B Q4_0 (MoE) — f16 KV

```
| model                          |       size |     params | backend    | ngl |            test |                  t/s |
| ------------------------------ | ---------: | ---------: | ---------- | --: | --------------: | -------------------: |
| qwen35moe 35B.A3B Q4_0         |  19.78 GiB |    34.66 B | ROCm       |  99 |           pp512 |      750.71 ± 397.38 |
| qwen35moe 35B.A3B Q4_0         |  19.78 GiB |    34.66 B | ROCm       |  99 |          pp1024 |       1203.64 ± 9.89 |
| qwen35moe 35B.A3B Q4_0         |  19.78 GiB |    34.66 B | ROCm       |  99 |           tg128 |         60.15 ± 4.64 |
| qwen35moe 35B.A3B Q4_0         |  19.78 GiB |    34.66 B | ROCm       |  99 |           tg256 |         63.15 ± 0.05 |
```

### Qwen3.5 35B-A3B Q4_0 (MoE) — turbo3 KV

```
| model                          |       size |     params | backend    | ngl | type_k | type_v |            test |                  t/s |
| ------------------------------ | ---------: | ---------: | ---------- | --: | -----: | -----: | --------------: | -------------------: |
| qwen35moe 35B.A3B Q4_0         |  19.78 GiB |    34.66 B | ROCm       |  99 | turbo3 | turbo3 |           pp512 |      638.33 ± 290.03 |
| qwen35moe 35B.A3B Q4_0         |  19.78 GiB |    34.66 B | ROCm       |  99 | turbo3 | turbo3 |          pp1024 |        903.25 ± 3.13 |
| qwen35moe 35B.A3B Q4_0         |  19.78 GiB |    34.66 B | ROCm       |  99 | turbo3 | turbo3 |           tg128 |         46.61 ± 0.86 |
| qwen35moe 35B.A3B Q4_0         |  19.78 GiB |    34.66 B | ROCm       |  99 | turbo3 | turbo3 |           tg256 |         46.78 ± 0.12 |
```
